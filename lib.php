 ...
 * @param mixed $context context object or null
 * @return bool returns true if the user is allowd to edit the entry, false otherwise
 */
function data_user_can_manage_entry($record, $data, $context = null) {
    global $DB;

    if ($context == null) {
        $cm = get_coursemodule_from_instance('data', $data->dataid, 0, false, MUST_EXIST);
        $context = context_module::instance($cm->id);
    }
